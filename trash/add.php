...
<html>
	...
	<!--
        <div class="topnav">
            ...
            <a class="active" href="add.php">Yeni CV Ekle</a>
        </div>
	-->
		<nav class="navbar navbar-default">
		  <div class="container-fluid">
			...
			<ul class="nav navbar-nav">
			  ...
			  <li class="active"><a href="add.php">Yeni CV Ekle</a></li>
			</ul>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="conn.php" method="POST" enctype="multipart/form-data">
			...
			<!--DENEYİM BİLGİLERİ PANELİ-->
				...
				<div class="panel panel-default">
						<div class="panel-heading">HESAP BİLGİLERİ</div>
						
						<div class="panel-body">

									<div class="row-sm-4">
										<div class="form-group">
											<label class="col-sm-4 control-label">KULLANICI ADI</label>
											<div class="col-sm-4"><input type="text" name="addusername" class="form-control" ></div>
										</div>
									</div>

									<div class="row-sm-4">
										<div class="form-group">
											<label class="col-sm-4 control-label">ŞİFRE</label>
											<div class="col-sm-4"><input type="password" name="addpassword" class="form-control " ></div>
										</div>
									</div>
									
									<div class="row-sm-4">
										<div class="form-group">
											<label class="col-sm-4 control-label">SIFRE TEKRAR</label>
											<div class="col-sm-4"><input type="password" name="addcheckpassword" class="form-control" ></div>
										</div>
									</div>
                ...
                <p>
                    <input  class ="btn btn-success gonder-btn" type="submit"></input><!--CONN.PHP-->
                </p>
