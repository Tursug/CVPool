		...
		<nav class="navbar navbar-default">
		  <div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
			  <li><a href="editMyAccount.php?name=kullanici&id=<?php echo $id; ?>"><span class="glyphicon glyphicon-user"></span> Kullanıcı Adı</a></li>
			...
			<!--KİŞİSEL BİLGİLER PANELİ-->
                    <div class="panel panel-default">
						...
						<div class="row">
							...
							<input type="hidden" value=<?php echo $id;?> name="idhere"></input>
							</div>
						</div>
					</div>
				</div>
